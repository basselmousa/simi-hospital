    ...
    <div class="scrollbar-sidebar ps ps--active-y">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu metismenu">
                ...
                <li>
                    <a href="#">
                        <i class="metismenu-icon pe-7s-way"></i>Appointments
                    </a>
                    <ul>
                        <li>
                            <a href="{{ route('dashboard.doctor.appointments.doctor-home') }}" class="mm-active">
                                <i class="metismenu-icon"></i>Home Medicine Appointments
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dashboard.doctor.appointments.doctor-clinic') }}">
                                <i class="metismenu-icon"></i>Clinic
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dashboard.doctor.appointments.doctor-care') }}">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('dashboard.doctor.dates.index') }}" class="mm-active">
                                <i class="metismenu-icon"></i>Dates
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dashboard.doctor.certificates.index') }}">
                                <i class="metismenu-icon"></i>Certificates
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dashboard.doctor.homeable.index') }}">
                                <i class="metismenu-icon">
                                </i>Homeable Care
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('dashboard.doctor.secretary.index') }}">
                                <i class="metismenu-icon">
                                </i>Secretary
                            </a>
                        </li>
