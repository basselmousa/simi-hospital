<div class="tab-pane fade active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-home-tab-custom">
    <form action="{{ route('dashboard.doctor.profile.update') }}" method="post" class="pt-3" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="email" name="email" class="form-control form-control"
                           ...
                           placeholder="Email" readonly value="{{ old('email') ?? $doctor->email}}">
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="building_number" class="form-control form-control"
                           id="exampleInputEmail1"
                           placeholder="Building Number" value="{{ old('building_number') ?? $doctor->building_number }}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="phone_number" class="form-control form-control"
                           id="exampleInputEmail1"
                           placeholder="Phone Number" value="{{ old('phone_number') ?? $doctor->phone_number }}">
                    @error('phone_number')
                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
